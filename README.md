...
Master Mind solver for the standard version with 6 colors and 4 placements. The solver plays optimal<sup>*</sup> by finding the move that on average decreases the solution space the most.<br/>
